...
public class KategorilerAdapter_Bebek extends RecyclerView.Adapter<KategorilerAdapter_Bebek.MyViewHolder> {
    ...
    public KategorilerAdapter_Bebek(Context context, List<Kategoriler> kategorilerList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.kategori_cardview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                activity.getSupportFragmentManager().beginTransaction().replace(R.id.urunlistele_bebek, new Urunler_listele_Fragment()).addToBackStack(null).commit();
