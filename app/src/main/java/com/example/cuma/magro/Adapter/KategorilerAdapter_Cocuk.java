...
public class KategorilerAdapter_Cocuk extends RecyclerView.Adapter<KategorilerAdapter_Cocuk.MyViewHolder> {
    ...
    public KategorilerAdapter_Cocuk(Context context, List<Kategoriler> kategorilerList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.kategori_cardview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                activity.getSupportFragmentManager().beginTransaction().replace(R.id.urunlistele_cocuk, new Urunler_listele_Fragment()).addToBackStack(null).commit();
