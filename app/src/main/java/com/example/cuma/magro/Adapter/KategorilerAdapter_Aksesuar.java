...
public class KategorilerAdapter_Aksesuar extends RecyclerView.Adapter<KategorilerAdapter_Aksesuar.MyViewHolder> {
   ...
   /*todo değişilkil*/
    ...
    public KategorilerAdapter_Aksesuar(Context context, List<Kategoriler> kategorilerList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.kategori_cardview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(context, String.valueOf(200 + i), Toast.LENGTH_LONG).show();
                AppCompatActivity activity = (AppCompatActivity) view.getContext();
                activity.getSupportFragmentManager().beginTransaction().replace(R.id.urunlistele_aksesuar, new Urunler_listele_Fragment()).addToBackStack(null).commit();
