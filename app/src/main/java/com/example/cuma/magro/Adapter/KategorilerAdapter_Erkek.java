...
public class KategorilerAdapter_Erkek extends RecyclerView.Adapter<KategorilerAdapter_Erkek.MyViewHolder> {
    ...
    public KategorilerAdapter_Erkek(Context context, List<Kategoriler> kategorilerList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.kategori_cardview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                activity.getSupportFragmentManager().beginTransaction().replace(R.id.urunlistele_erkek, new Urunler_listele_Fragment()).addToBackStack(null).commit();
