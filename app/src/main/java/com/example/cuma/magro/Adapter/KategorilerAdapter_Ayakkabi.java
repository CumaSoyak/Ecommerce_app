...
public class KategorilerAdapter_Ayakkabi extends RecyclerView.Adapter<KategorilerAdapter_Ayakkabi.MyViewHolder> {
    ...
    public KategorilerAdapter_Ayakkabi(Context context, List<Kategoriler> kategorilerList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.kategori_cardview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                activity.getSupportFragmentManager().beginTransaction().replace(R.id.urunlistele_ayakkabi, new Urunler_listele_Fragment()).addToBackStack(null).commit();
